...
nothing under core/, v2/, models/, data/, api/, feature_store/, or
decision_engine/ should import the `research` package. Research code may
depend on production code (it already does - core.indicators,
core.scoring); production must never depend on research code.
...
PRODUCTION_DIRS = ["core", "v2", "models", "data", "api", "feature_store", "decision_engine"]
